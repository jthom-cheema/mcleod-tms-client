...
**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=deleteEquipPref&role=-1&service=EquipmentPreferencesService
...
# DELETE /equipmentPreferences/{id}
...
**Endpoint:** `DELETE /equipmentPreferences/{id}`
...
```http
DELETE /equipmentPreferences/{id} HTTP/1.1
