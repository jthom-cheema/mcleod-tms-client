# McLeod API Documentation - /symphonymcmessages/tractor

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getTractor&role=-1&service=SymphonyMobileCommService
...
# GET /symphonymcmessages/tractor
...
response object indicating the success or failure of returning the tractor record

## Request Details

**Endpoint:** `GET /symphonymcmessages/tractor`
...
```http
GET /symphonymcmessages/tractor HTTP/1.1
