# McLeod API Documentation - /{table}/new

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=neww&role=-1&service=TableRowService
