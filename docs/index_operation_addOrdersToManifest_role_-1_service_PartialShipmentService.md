# McLeod API Documentation - /partialShipment/{movementId}/addOrdersToManifest/{orderIds}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=addOrdersToManifest&role=-1&service=PartialShipmentService
...
orderIds | Comma delimited list of order id values you are adding to the manifest. |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `POST /partialShipment/{movementId}/addOrdersToManifest/{orderIds}`
...
```http
POST /partialShipment/{movementId}/addOrdersToManifest/{orderIds} HTTP/1.1
