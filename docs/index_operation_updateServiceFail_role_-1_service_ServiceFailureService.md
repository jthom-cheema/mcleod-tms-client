# McLeod API Documentation - /serviceFailures/update

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=updateServiceFail&role=-1&service=ServiceFailureService
...
---|---|---|---|---  
serviceFail | the data to use when updating the existing RowServiceFail record |  body _of type: application/xml application/json_ |  |  [RowServiceFail](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowServiceFail&role=-1)  
...
**Endpoint:** `PUT /serviceFailures/update`
...
```http
PUT /serviceFailures/update HTTP/1.1
