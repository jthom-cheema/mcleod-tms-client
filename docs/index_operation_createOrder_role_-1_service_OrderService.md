# McLeod API Documentation - /orders/create

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=createOrder&role=-1&service=OrderService
