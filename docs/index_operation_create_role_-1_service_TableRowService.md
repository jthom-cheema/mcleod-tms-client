# McLeod API Documentation - /{table}/create

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=create&role=-1&service=TableRowService
