# McLeod API Documentation - /pnnLane/create

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=createPnnLane&role=-1&service=PNNLaneService
...
---|---|---|---|---  
newRow |  |  body _of type: application/xml_ |  |  [RowPnnLane](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowPnnLane&role=-1)  
