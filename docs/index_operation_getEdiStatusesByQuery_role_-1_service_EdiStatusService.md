# McLeod API Documentation - /ediStatus

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getEdiStatusesByQuery&role=-1&service=EdiStatusService
...
---|---|---|---|---  
q | string for which to search for shipment statuses by order ID, partner name, partner ID, or alternate partner ID |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
