...
**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=deleteAvailableTractor&role=-1&service=AvailableTractorService
...
Roles that can access this endpoint are [ Users, Carriers, Freight Matching](https://tms-cfaa.loadtracking.com:5690/ws/docs/roles?role=-1). 
...
**Endpoint:** `DELETE /availableTractors/{id}`
...
```http
DELETE /availableTractors/{id} HTTP/1.1
