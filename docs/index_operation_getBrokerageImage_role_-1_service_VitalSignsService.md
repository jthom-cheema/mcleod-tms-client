# McLeod API Documentation - /vitalSigns/brokerage/image

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getBrokerageImage&role=-1&service=VitalSignsService

---

go back to [VitalSignsService](https://tms-cfaa.loadtracking.com:5690/ws/docs/services?service=VitalSignsService&role=-1)

# GET /vitalSigns/brokerage/image
...
**Endpoint:** `GET /vitalSigns/brokerage/image`
...
```http
GET /vitalSigns/brokerage/image HTTP/1.1
