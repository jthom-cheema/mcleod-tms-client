# McLeod API Documentation - /quoteOrders/create

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=createQuoteOrder&role=-1&service=QuoteOrderService
...
---|---|---|---|---  
quote | the data to use when updating the existing quote-order record |  body _of type: application/xml application/json_ |  |  [RowQuoteOrder](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowQuoteOrder&role=-1)  
  
* * *

## Result

[RowQuoteOrder](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowQuoteOrder&role=-1) _of type: application/xml application/json_

the created RowQuoteOrder object   
...
**Endpoint:** `PUT /quoteOrders/create`
...
- **Type:** [RowQuoteOrder](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowQuoteOrder&role=-1)
- **Content-Type:** application/xml application/json

### Example Request

```http
PUT /quoteOrders/create HTTP/1.1
