# McLeod API Documentation - RowMiscBill

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/types?role=-1&type=com.tms.common.loadmaster.tablerows.RowMiscBill
...
The following is only an example of what the XML should look like. The order of fields is not guaranteed and null fields are not included in returned data from the services.
    ...
    <misc_bill company_id="..." id="..." ar_cycle_code_id="..." bill_date="..." bill_type="..." billing_user_id="..." customer_id="..." end_date="..." invoice_no="..." invoice_no_string="..." last_bill_date="..." order_id="..." printed="..." purchase_order_no="..." ready_to_process="..." recur_billed_amt="..." recur_billed_amt_c="..." recur_billed_amt_d="..." recur_billed_amt_n="..." recur_billed_amt_r="..." recur_billed_no="..." reference_number="..." remark="..." start_date="..." total_charges="..." total_charges_c="..." total_charges_d="..." total_charges_n="..." total_charges_r="..." totalcharge_and_excisetax="..." totalcharge_and_excisetax_c="..." totalcharge_and_excisetax_d="..." totalcharge_and_excisetax_n="..." totalcharge_and_excisetax_r="..." tw_seg_code="..."/>
...
The following is only an example of what the JSON should look like. The order of fields is not guaranteed and null fields are not included in returned data from the services.
    ...
    {"__type":"misc_bill","company_id":"...","id":"...","ar_cycle_code_id":"...","bill_date":"...","bill_type":"...","billing_user_id":"...","customer_id":"...","end_date":"...","invoice_no":"...","invoice_no_string":"...","last_bill_date":"...","order_id":"...","printed":"...","purchase_order_no":"...","ready_to_process":"...","recur_billed_amt":"...","recur_billed_amt_c":"...","recur_billed_amt_d":"...","recur_billed_amt_n":"...","recur_billed_amt_r":"...","recur_billed_no":"...","reference_number":"...","remark":"...","start_date":"...","total_charges":"...","total_charges_c":"...","total_charges_d":"...","total_charges_n":"...","total_charges_r":"...","totalcharge_and_excisetax":"...","totalcharge_and_excisetax_c":"...","totalcharge_and_excisetax_d":"...","totalcharge_and_excisetax_n":"...","totalcharge_and_excisetax_r":"...","tw_seg_code":"..."}
...
| ar_cycle_code_id |  2  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String?role=-1)  
...
| end_date |  10  |  [Date](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.lib.Date?role=-1)  
...
| recur_billed_amt |  16.2  |  [BigDecimal](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.math.BigDecimal?role=-1)  
| recur_billed_amt_c |  3  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String?role=-1)  
| recur_billed_amt_d |  19  |  [Date](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.lib.Date?role=-1)  
| recur_billed_amt_n |  16.2  |  [BigDecimal](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.math.BigDecimal?role=-1)  
| recur_billed_amt_r |  10.6  |  [BigDecimal](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.math.BigDecimal?role=-1)  
| recur_billed_no |  10  |  [int](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=int?role=-1)  
