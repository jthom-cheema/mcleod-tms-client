# McLeod API Documentation - /symphonymcmessages/workflowspreassigned

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getWorkflowsPreassigned&role=-1&service=SymphonyMobileCommService
...
# GET /symphonymcmessages/workflowspreassigned

Retrieves Workflows Preassigned for vendorId and driverId
...
**Endpoint:** `GET /symphonymcmessages/workflowspreassigned`
...
```http
GET /symphonymcmessages/workflowspreassigned HTTP/1.1
