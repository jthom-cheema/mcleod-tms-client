# McLeod API Documentation - /mobileTableConfigs/create

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=createMobileTableConfig&role=-1&service=MobileTableConfigService
...
---|---|---|---|---  
tableConfig | the data to use when creating the new table configuration |  body _of type: application/xml application/json_ |  |  [RowMobileTableConfig](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowMobileTableConfig&role=-1)  
...
**Endpoint:** `PUT /mobileTableConfigs/create`
...
```http
PUT /mobileTableConfigs/create HTTP/1.1
