# McLeod API Documentation - /osd/header/new

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=newOsdHeader&role=-1&service=OSDService
