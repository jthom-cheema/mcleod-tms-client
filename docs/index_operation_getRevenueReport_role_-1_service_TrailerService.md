# McLeod API Documentation - /trailers/{id}/revenueReport

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getRevenueReport&role=-1&service=TrailerService

---

go back to [TrailerService](https://tms-cfaa.loadtracking.com:5690/ws/docs/services?service=TrailerService&role=-1)

# GET /trailers/{id}/revenueReport

Produces a trailer revenue report.
...
---|---|---|---|---  
id | trailer ID for which to run the report |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `GET /trailers/{id}/revenueReport`
...
```http
GET /trailers/{id}/revenueReport HTTP/1.1
