# McLeod API Documentation - /equipmentPreferences/create

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=createEquipPref&role=-1&service=EquipmentPreferencesService
...
---|---|---|---|---  
newRow |  |  body _of type: application/xml application/json_ |  |  [RowDrsPayeeEquip](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowDrsPayeeEquip&role=-1)  
...
**Endpoint:** `PUT /equipmentPreferences/create`
...
```http
PUT /equipmentPreferences/create HTTP/1.1
