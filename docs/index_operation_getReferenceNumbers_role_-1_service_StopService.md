# McLeod API Documentation - /stops/{id}/referenceNumbers

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getReferenceNumbers&role=-1&service=StopService

---

go back to [StopService](https://tms-cfaa.loadtracking.com:5690/ws/docs/services?service=StopService&role=-1)

# GET /stops/{id}/referenceNumbers
...
**Endpoint:** `GET /stops/{id}/referenceNumbers`
...
```http
GET /stops/{id}/referenceNumbers HTTP/1.1
