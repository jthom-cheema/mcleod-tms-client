# McLeod API Documentation - /users/clearPushToken

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=clearPushToken&role=-1&service=UserService

---

go back to [UserService](https://tms-cfaa.loadtracking.com:5690/ws/docs/services?service=UserService&role=-1)

# POST /users/clearPushToken

Removes the push token in the database so that push notifications may not be sent.
...
**Endpoint:** `POST /users/clearPushToken`
...
```http
POST /users/clearPushToken HTTP/1.1
