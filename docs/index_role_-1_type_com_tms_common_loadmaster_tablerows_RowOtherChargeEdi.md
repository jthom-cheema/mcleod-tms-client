# McLeod API Documentation - RowOtherChargeEdi

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/types?role=-1&type=com.tms.common.loadmaster.tablerows.RowOtherChargeEdi
...
The following is only an example of what the XML should look like. The order of fields is not guaranteed and null fields are not included in returned data from the services.
    ...
    <other_charge_edi company_id="..." id="..." allocated_charge_key="..." allocation_method="..." amount="..." amount_c="..." amount_d="..." amount_n="..." amount_r="..." bill_type="..." calc_method="..." charge_id="..." currency_iso_id="..." customer_id="..." ded_charge_customer_id="..." descr="..." direction="..." driver_id="..." edi_charge_code="..." empty_distance_units="..." empty_distance_units_um="..." est_fuel_surcharge="..." incl_in_freight="..." invoice_id="..." is_dedicated_distance="..." is_taxable="..." jag_rate_id="..." loaded_distance_units="..." loaded_distance_units_um="..." ltl_allocation_method="..." maximum_units="..." minimum_units="..." order_id="..." order_oc_id="..." rate="..." rate_id="..." revenue_share_order_id="..." sequence="..." stop_id="..." stop_loc_name="..." stop_no="..." tli_uid="..." units="..."/>
...
The following is only an example of what the JSON should look like. The order of fields is not guaranteed and null fields are not included in returned data from the services.
    ...
    {"__type":"other_charge_edi","company_id":"...","id":"...","allocated_charge_key":"...","allocation_method":"...","amount":"...","amount_c":"...","amount_d":"...","amount_n":"...","amount_r":"...","bill_type":"...","calc_method":"...","charge_id":"...","currency_iso_id":"...","customer_id":"...","ded_charge_customer_id":"...","descr":"...","direction":"...","driver_id":"...","edi_charge_code":"...","empty_distance_units":"...","empty_distance_units_um":"...","est_fuel_surcharge":"...","incl_in_freight":"...","invoice_id":"...","is_dedicated_distance":"...","is_taxable":"...","jag_rate_id":"...","loaded_distance_units":"...","loaded_distance_units_um":"...","ltl_allocation_method":"...","maximum_units":"...","minimum_units":"...","order_id":"...","order_oc_id":"...","rate":"...","rate_id":"...","revenue_share_order_id":"...","sequence":"...","stop_id":"...","stop_loc_name":"...","stop_no":"...","tli_uid":"...","units":"..."}
...
| edi_charge_code |  50  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String?role=-1)  
