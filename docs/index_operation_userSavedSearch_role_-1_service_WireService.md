# McLeod API Documentation - /wires/userSavedSearch

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=userSavedSearch&role=-1&service=WireService
...
a list of RowUnpostedWire objects

## Request Details

**Endpoint:** `GET /wires/userSavedSearch`
...
```http
GET /wires/userSavedSearch HTTP/1.1
