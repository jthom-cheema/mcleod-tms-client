# McLeod API Documentation - RowOtherCharge

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/types?role=-1&type=com.tms.common.loadmaster.tablerows.RowOtherCharge
...
The following is only an example of what the XML should look like. The order of fields is not guaranteed and null fields are not included in returned data from the services.
    ...
    <other_charge company_id="..." id="..." allocated_charge_key="..." allocation_method="..." amount="..." amount_c="..." amount_d="..." amount_n="..." amount_r="..." bill_type="..." calc_method="..." cfaa_review_approval="..." charge_id="..." customer_id="..." ded_charge_customer_id="..." descr="..." driver_id="..." empty_distance_units="..." empty_distance_units_um="..." est_fuel_surcharge="..." incl_in_freight="..." is_dedicated_distance="..." is_taxable="..." jag_rate_id="..." loaded_distance_units="..." loaded_distance_units_um="..." ltl_allocation_method="..." order_id="..." rate="..." rate_id="..." revenue_share_order_id="..." sequence="..." stop_id="..." stop_loc_name="..." stop_movement_sequence="..." stop_no="..." tli_uid="..." units="..."/>
...
| cfaa_review_approval |  1  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String?role=-1)  
...
| stop_movement_sequence |  10  |  [int](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=int?role=-1)  
