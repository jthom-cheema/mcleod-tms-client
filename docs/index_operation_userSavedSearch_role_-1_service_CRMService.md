# McLeod API Documentation - /crm/prospects/userSavedSearch

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=userSavedSearch&role=-1&service=CRMService
...
**Endpoint:** `GET /crm/prospects/userSavedSearch`
...
```http
GET /crm/prospects/userSavedSearch HTTP/1.1
