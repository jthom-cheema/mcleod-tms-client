# McLeod API Documentation - /orders/{id}/deliveryReceipt

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getDeliveryReceipt&role=-1&service=OrderService
...
---|---|---|---|---  
id | ID of the order for which to produce a delivery receipt |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `GET /orders/{id}/deliveryReceipt`
...
```http
GET /orders/{id}/deliveryReceipt HTTP/1.1
