# McLeod API Documentation - /motorAccidents/userSavedSearch

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=userSavedSearch&role=-1&service=MotorAccidentService
...
# GET /motorAccidents/userSavedSearch

Retrieves a List of RowMotorAccident objects based on an existing saved search.
...
**Endpoint:** `GET /motorAccidents/userSavedSearch`
...
```http
GET /motorAccidents/userSavedSearch HTTP/1.1
