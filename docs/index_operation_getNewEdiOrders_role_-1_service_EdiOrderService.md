# McLeod API Documentation - /ediOrder/retrieveRecords/new

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getNewEdiOrders&role=-1&service=EdiOrderService
...
**Endpoint:** `GET /ediOrder/retrieveRecords/new`
...
```http
GET /ediOrder/retrieveRecords/new HTTP/1.1
