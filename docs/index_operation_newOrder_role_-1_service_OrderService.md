# McLeod API Documentation - /orders/new

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=newOrder&role=-1&service=OrderService
...
---|---|---|---|---  
recurringOrderId | the ID of the recurring order that we'll use to fill the order object (optional) |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
