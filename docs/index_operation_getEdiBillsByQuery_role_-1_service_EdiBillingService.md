# McLeod API Documentation - /ediBilling

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getEdiBillsByQuery&role=-1&service=EdiBillingService
...
Retrieves a List of RowEdiBilling objects with a full or partial match to the given value.
...
---|---|---|---|---  
q | string for which to search for EDI Bills by order ID, partner name, partner ID, or alternate partner ID |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
