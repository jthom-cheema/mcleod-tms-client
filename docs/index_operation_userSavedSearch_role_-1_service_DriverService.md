# McLeod API Documentation - /drivers/userSavedSearch

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=userSavedSearch&role=-1&service=DriverService
...
**Endpoint:** `GET /drivers/userSavedSearch`
...
```http
GET /drivers/userSavedSearch HTTP/1.1
