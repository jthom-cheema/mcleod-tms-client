# McLeod API Documentation - /tractors/{id}/preassignments

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getPreassignments&role=-1&service=TractorService
...
---|---|---|---|---  
id | ID of the tractor for which to return preassignments |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `GET /tractors/{id}/preassignments`
...
```http
GET /tractors/{id}/preassignments HTTP/1.1
