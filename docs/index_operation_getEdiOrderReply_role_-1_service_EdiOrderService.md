# McLeod API Documentation - /ediOrder/retrieveRecords/reply

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getEdiOrderReply&role=-1&service=EdiOrderService
...
batch |  |  query  |  |  [int](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=int&role=-1)  
beginBatch |  |  query  |  |  [int](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=int&role=-1)  
endBatch |  |  query  |  |  [int](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=int&role=-1)  
beginDate |  |  query  |  |  [Date](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.lib.Date&role=-1)  
...
**Endpoint:** `GET /ediOrder/retrieveRecords/reply`
...
```http
GET /ediOrder/retrieveRecords/reply HTTP/1.1
