# McLeod API Documentation - /motorAccidents/update

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=updateMotorAccident&role=-1&service=MotorAccidentService
...
---|---|---|---|---  
accident | the RowMotorAccident record to be updated |  body _of type: application/xml application/json_ |  |  [RowMotorAccident](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowMotorAccident&role=-1)  
...
**Endpoint:** `PUT /motorAccidents/update`
...
```http
PUT /motorAccidents/update HTTP/1.1
