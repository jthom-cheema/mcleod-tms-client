# McLeod API Documentation - /dispatch/unsplit/{movementId}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=unsplitMovement&role=-1&service=DispatchService
...
---|---|---|---|---  
movementId | ID of the movement to be unsplit |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `POST /dispatch/unsplit/{movementId}`
...
```http
POST /dispatch/unsplit/{movementId} HTTP/1.1
