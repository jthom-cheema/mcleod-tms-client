# McLeod API Documentation - /carrierDispatch/logisticsTender/sendNonCancelTender/{movementId}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=sendNonCancelTender&role=-1&service=CarrierDispatchService
...
**Endpoint:** `POST /carrierDispatch/logisticsTender/sendNonCancelTender/{movementId}`
...
```http
POST /carrierDispatch/logisticsTender/sendNonCancelTender/{movementId} HTTP/1.1
