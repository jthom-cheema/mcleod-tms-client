# McLeod API Documentation - /drivers/{id}/preassignments

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getPreassignments&role=-1&service=DriverService
...
**Endpoint:** `GET /drivers/{id}/preassignments`
...
```http
GET /drivers/{id}/preassignments HTTP/1.1
