# McLeod API Documentation - /payees

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getPayeeByQuery&role=-1&service=PayeeService
...
---|---|---|---|---  
q | string for which to search for payees by name or ID |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
