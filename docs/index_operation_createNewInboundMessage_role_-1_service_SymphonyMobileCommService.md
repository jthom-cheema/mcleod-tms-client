...
**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=createNewInboundMessage&role=-1&service=SymphonyMobileCommService
...
# POST /symphonymcmessages

Creates a new RowMcMessage and sends it back to the dispatch system from the unit specified in the object.
...
---|---|---|---|---  
rowMcMessage |  |  body _of type: application/xml application/json_ |  |  [RowMcMessage](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowMcMessage&role=-1)  
...
**Endpoint:** `POST /symphonymcmessages`
...
```http
POST /symphonymcmessages HTTP/1.1
