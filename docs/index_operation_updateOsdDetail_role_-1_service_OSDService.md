# McLeod API Documentation - /osd/detail/update

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=updateOsdDetail&role=-1&service=OSDService

---

go back to [OSDService](https://tms-cfaa.loadtracking.com:5690/ws/docs/services?service=OSDService&role=-1)

# PUT /osd/detail/update
...
---|---|---|---|---  
updatedRow |  |  body _of type: application/xml_ |  |  [RowOsdDtl](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowOsdDtl&role=-1)  
...
**Endpoint:** `PUT /osd/detail/update`
...
```http
PUT /osd/detail/update HTTP/1.1
