# McLeod API Documentation - /crm/prospectActions/new

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=newProspectAction&role=-1&service=CRMService
...
---|---|---|---|---  
prospectId |  |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `GET /crm/prospectActions/new`
...
```http
GET /crm/prospectActions/new HTTP/1.1
