# McLeod API Documentation - /ediBilling/submit

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=submitInvoices&role=-1&service=EdiBillingService

---

go back to [EdiBillingService](https://tms-cfaa.loadtracking.com:5690/ws/docs/services?service=EdiBillingService&role=-1)

# POST /ediBilling/submit

Allows a partner to submit billing data for processing.
...
**Endpoint:** `POST /ediBilling/submit`
...
```http
POST /ediBilling/submit HTTP/1.1
