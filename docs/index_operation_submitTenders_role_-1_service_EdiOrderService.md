# McLeod API Documentation - /ediOrder/submitTender

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=submitTenders&role=-1&service=EdiOrderService
...
**Endpoint:** `PUT /ediOrder/submitTender`
...
```http
PUT /ediOrder/submitTender HTTP/1.1
