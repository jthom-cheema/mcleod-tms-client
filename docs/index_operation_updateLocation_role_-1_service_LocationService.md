# McLeod API Documentation - /locations/update

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=updateLocation&role=-1&service=LocationService
...
---|---|---|---|---  
location | the data to use when updating the existing Location record |  body _of type: application/xml application/json_ |  |  [RowLocation](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowLocation&role=-1)  
