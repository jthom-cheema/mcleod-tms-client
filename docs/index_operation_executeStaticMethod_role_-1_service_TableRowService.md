# McLeod API Documentation - /{table}/{method}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=executeStaticMethod&role=-1&service=TableRowService
