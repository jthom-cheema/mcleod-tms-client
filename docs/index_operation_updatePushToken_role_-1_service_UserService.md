# McLeod API Documentation - /users/updatePushToken

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=updatePushToken&role=-1&service=UserService
...
pushToken | the pushToken generated by the device |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `POST /users/updatePushToken`
...
```http
POST /users/updatePushToken HTTP/1.1
