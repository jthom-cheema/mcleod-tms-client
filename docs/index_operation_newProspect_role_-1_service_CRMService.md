# McLeod API Documentation - /crm/prospects/new

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=newProspect&role=-1&service=CRMService
...
**Endpoint:** `GET /crm/prospects/new`
...
```http
GET /crm/prospects/new HTTP/1.1
