# McLeod API Documentation - /ediOrder/{id}/replyRawDataWithErrors

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getReplyRawDataWithErrors&role=-1&service=EdiOrderService
...
---|---|---|---|---  
id | the ID of the load tender for which reply raw data should be returned |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `GET /ediOrder/{id}/replyRawDataWithErrors`
...
```http
GET /ediOrder/{id}/replyRawDataWithErrors HTTP/1.1
