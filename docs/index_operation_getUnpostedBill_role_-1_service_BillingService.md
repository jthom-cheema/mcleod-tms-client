# McLeod API Documentation - /billing/{id}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getUnpostedBill&role=-1&service=BillingService
...
---|---|---|---|---  
id | ID of the billing record to be retrieved |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
