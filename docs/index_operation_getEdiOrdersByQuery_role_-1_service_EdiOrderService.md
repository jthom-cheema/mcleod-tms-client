# McLeod API Documentation - /ediOrder

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getEdiOrdersByQuery&role=-1&service=EdiOrderService
...
---|---|---|---|---  
q | string for which to search for load tenders by load tender ID, order ID, partner name, partner ID, or alternate partner ID |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
