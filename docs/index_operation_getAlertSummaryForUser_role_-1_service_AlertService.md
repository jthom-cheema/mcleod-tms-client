# McLeod API Documentation - /alerts/summary

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getAlertSummaryForUser&role=-1&service=AlertService
...
[List](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.util.List&role=-1) < [AlertSummaryItem](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.ws.loadmaster.rapidalert.AlertSummaryItem&role=-1) > _of type: application/xml application/json_
