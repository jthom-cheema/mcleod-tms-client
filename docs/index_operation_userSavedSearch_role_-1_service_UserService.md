# McLeod API Documentation - /users/userSavedSearch

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=userSavedSearch&role=-1&service=UserService

---

go back to [UserService](https://tms-cfaa.loadtracking.com:5690/ws/docs/services?service=UserService&role=-1)

# GET /users/userSavedSearch

Retrieves a List of RowUsers objects based on an existing saved search.
...
**Endpoint:** `GET /users/userSavedSearch`
...
```http
GET /users/userSavedSearch HTTP/1.1
