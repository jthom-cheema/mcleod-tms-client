# McLeod API Documentation - /ediBilling/{id}/rawDataWithErrors

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getRawDataWithErrors&role=-1&service=EdiBillingService
...
---|---|---|---|---  
id | the ID for the EDI Bill for which raw data should be returned |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `GET /ediBilling/{id}/rawDataWithErrors`
...
```http
GET /ediBilling/{id}/rawDataWithErrors HTTP/1.1
