# McLeod API Documentation - /carrierDriverMessages/{id}/updateStatus

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=updateStatus&role=-1&service=CarrierDriverMessageService
...
**Endpoint:** `POST /carrierDriverMessages/{id}/updateStatus`
...
```http
POST /carrierDriverMessages/{id}/updateStatus HTTP/1.1
