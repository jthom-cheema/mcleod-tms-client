# McLeod API Documentation - /crm/prospectActions/update

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=updateProspectAction&role=-1&service=CRMService
...
**Endpoint:** `PUT /crm/prospectActions/update`
...
```http
PUT /crm/prospectActions/update HTTP/1.1
