# McLeod API Documentation - /dispatch/clearPreassignments/{movementId}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=clearPreassignments&role=-1&service=DispatchService
...
**Endpoint:** `POST /dispatch/clearPreassignments/{movementId}`
...
```http
POST /dispatch/clearPreassignments/{movementId} HTTP/1.1
