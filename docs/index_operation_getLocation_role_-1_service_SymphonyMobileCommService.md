# McLeod API Documentation - /symphonymcmessages/location

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getLocation&role=-1&service=SymphonyMobileCommService
...
# GET /symphonymcmessages/location
...
response object indicating the success or failure of returning the location record

## Request Details

**Endpoint:** `GET /symphonymcmessages/location`
...
```http
GET /symphonymcmessages/location HTTP/1.1
