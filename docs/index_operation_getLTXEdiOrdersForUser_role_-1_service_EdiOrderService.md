# McLeod API Documentation - /ediOrder/ltx

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getLTXEdiOrdersForUser&role=-1&service=EdiOrderService
...
---|---|---|---|---  
userId | ID for the user whose Load Tender Express Profile will be used to query load tenders |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
