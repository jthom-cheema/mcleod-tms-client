# McLeod API Documentation - /quotes/update

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=update&role=-1&service=QuoteService
...
---|---|---|---|---  
quote | the quote record to update |  body _of type: application/xml application/json_ |  |  [RowQuote](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowQuote&role=-1)  
