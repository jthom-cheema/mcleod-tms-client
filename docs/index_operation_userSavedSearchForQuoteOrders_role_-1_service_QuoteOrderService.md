# McLeod API Documentation - /quoteOrders/userSavedSearch

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=userSavedSearchForQuoteOrders&role=-1&service=QuoteOrderService
...
[List](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.util.List&role=-1) < [RowQuoteOrder](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.loadmaster.tablerows.RowQuoteOrder&role=-1) > _of type: application/xml application/json_
...
**Endpoint:** `GET /quoteOrders/userSavedSearch`
...
```http
GET /quoteOrders/userSavedSearch HTTP/1.1
