# McLeod API Documentation - /deductions/history

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getDeductionHistory&role=-1&service=DeductionService
...
a list of `[ReadOnlyRow](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=com.tms.common.lib.data.ReadOnlyRow)` objects, representing deduction history record   
  
Additional attributes: 

## Request Details

**Endpoint:** `GET /deductions/history`
...
```http
GET /deductions/history HTTP/1.1
