# McLeod API Documentation - /ediStops/{id}/stopNotes

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getStopNotes&role=-1&service=EdiStopService
...
**Endpoint:** `GET /ediStops/{id}/stopNotes`
...
```http
GET /ediStops/{id}/stopNotes HTTP/1.1
