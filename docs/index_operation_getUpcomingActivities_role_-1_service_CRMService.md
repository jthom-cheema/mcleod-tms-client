# McLeod API Documentation - /crm/prospects/{id}/upcoming

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getUpcomingActivities&role=-1&service=CRMService
...
**Endpoint:** `GET /crm/prospects/{id}/upcoming`
...
```http
GET /crm/prospects/{id}/upcoming HTTP/1.1
