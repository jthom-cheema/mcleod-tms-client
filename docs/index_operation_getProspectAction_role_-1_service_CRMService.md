# McLeod API Documentation - /crm/prospectActions/{id}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getProspectAction&role=-1&service=CRMService
...
---|---|---|---|---  
id | the ID of the ProspectAction to be retrieved |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `GET /crm/prospectActions/{id}`
...
```http
GET /crm/prospectActions/{id} HTTP/1.1
