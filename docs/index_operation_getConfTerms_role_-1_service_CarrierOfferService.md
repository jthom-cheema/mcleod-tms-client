# McLeod API Documentation - /carrierOffers/{id}/confTerms

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getConfTerms&role=-1&service=CarrierOfferService
...
Response object containing a pdf of the Order Offer Confirmation Terms.

## Request Details

**Endpoint:** `GET /carrierOffers/{id}/confTerms`
...
```http
GET /carrierOffers/{id}/confTerms HTTP/1.1
