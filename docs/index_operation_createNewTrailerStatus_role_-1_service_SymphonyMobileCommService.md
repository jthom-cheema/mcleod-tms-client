# McLeod API Documentation - /symphonymcmessages/trailerStatus

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=createNewTrailerStatus&role=-1&service=SymphonyMobileCommService
...
# POST /symphonymcmessages/trailerStatus

Creates a new Trailer status and alarm messages
...
---|---|---|---|---  
trailerStatusString |  |  body _of type: application/xml application/json_ |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `POST /symphonymcmessages/trailerStatus`
...
```http
POST /symphonymcmessages/trailerStatus HTTP/1.1
