...
---|---|---|---|---  
stopId | the ID of the stop to mark departed (not currently used) |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `POST /dispatch/{stopId}/depart`
...
```http
POST /dispatch/{stopId}/depart HTTP/1.1
