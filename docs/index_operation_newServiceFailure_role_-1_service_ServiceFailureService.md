# McLeod API Documentation - /serviceFailures/new

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=newServiceFailure&role=-1&service=ServiceFailureService
...
---|---|---|---|---  
stopId | the ID of the stop that is used to fill the default values (optional) |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `GET /serviceFailures/new`
...
```http
GET /serviceFailures/new HTTP/1.1
