# McLeod API Documentation - /dispatch/{stopId}/declineOffer

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=handleDriverOfferDecline&role=-1&service=DispatchService
...
---|---|---|---|---  
stopId | the ID of the stop to declined (not currently used) |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `POST /dispatch/{stopId}/declineOffer`
...
```http
POST /dispatch/{stopId}/declineOffer HTTP/1.1
