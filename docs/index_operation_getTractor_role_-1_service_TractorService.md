# McLeod API Documentation - /tractors/{id}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getTractor&role=-1&service=TractorService
...
---|---|---|---|---  
id | ID for the tractor to be returned |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
suggestTrailersAtStop | the ID of the stop record to which we're trying to assign |  query  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
