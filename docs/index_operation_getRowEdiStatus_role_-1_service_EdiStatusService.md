# McLeod API Documentation - /ediStatus/{id}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getRowEdiStatus&role=-1&service=EdiStatusService
...
---|---|---|---|---  
id | the ID of the shipment status to be returned |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
