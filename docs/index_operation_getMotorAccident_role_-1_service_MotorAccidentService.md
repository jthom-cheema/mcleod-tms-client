# McLeod API Documentation - /motorAccidents/{id}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getMotorAccident&role=-1&service=MotorAccidentService
...
---|---|---|---|---  
id | the ID of the record to be returned |  path  |  |  [String](https://tms-cfaa.loadtracking.com:5690/ws/docs/types?type=java.lang.String&role=-1)  
...
**Endpoint:** `GET /motorAccidents/{id}`
...
```http
GET /motorAccidents/{id} HTTP/1.1
