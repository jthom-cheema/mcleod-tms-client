# McLeod API Documentation - /symphonymcmessages/drivers

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getDrivers&role=-1&service=SymphonyMobileCommService
...
**Endpoint:** `GET /symphonymcmessages/drivers`
...
```http
GET /symphonymcmessages/drivers HTTP/1.1
