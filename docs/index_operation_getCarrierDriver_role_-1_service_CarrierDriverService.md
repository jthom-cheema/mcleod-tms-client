# McLeod API Documentation - /carrierDriver/{id}

**Source URL:** https://tms-cfaa.loadtracking.com:5690/ws/docs/services?operation=getCarrierDriver&role=-1&service=CarrierDriverService
